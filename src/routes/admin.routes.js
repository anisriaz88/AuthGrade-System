...
import { createUser, updateUser, deleteUser, getAllUsers } from '../controllers/admin.controller.js';
import { authenticate } from '../middleware/auth.middleware.js';
import { authorize } from '../middleware/roles.middleware.js';

const routerAdmin = express.Router();

 // This route can be used to create an initial admin account (should be removed in production)
